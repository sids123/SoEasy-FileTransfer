...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("random shit")
        self.initUI()

    def initUI(self):
        self.photo = QtWidgets.QLabel(self)
        self.photo.setGeometry(QtCore.QRect(500, 200, 300, 300))
        self.photo.setPixmap(QtGui.QPixmap("qr.png"))
        self.photo.setScaledContents(True)
        self.connection_made.connect(self.stop_display)
